...
const ContactSection: React.FC<ContactSectionProps> = ({ onNavigate }) => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'chozhaofficial@outlook.com',
      href: 'mailto:chozhaofficial@outlook.com'
    },
    {
      icon: Phone,
      label: 'Phone',
  ...
  const socialLinks = [
    ...
    { icon: Twitter, label: 'Portfolio', href: '/', color: 'cyan' },
  ];
  ...
  return (
    <section className="min-h-screen relative pt-20 px-6 pb-12">
      <RobotGuide
        character="omega"
        message="Final protocol activated! I'm OMEGA, your communications specialist. All systems are ready to establish contact. The human is eager to collaborate on exciting projects and discuss innovative solutions!"
        isVisible={showGuide}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Communication channels open. Ready to discuss your next groundbreaking project.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 p-8 rounded-3xl border border-orange-500/20">
            <h3 className="text-3xl font-bold text-orange-400 mb-4">Ready to Build Something Amazing?</h3>
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Whether it's a cutting-edge web application, mobile app, or AI-powered solution, 
              let's collaborate to bring your vision to life with the latest technologies.
            </p>
